export default {
  ...
  educationTitle: "Bachelor of Computer Science",
  educationDate: "Menofia University • 2020 - 2024",
  ...
  projectsDescription:
    "Here are some of the projects I've worked on. Each project is built with care and attention to detail.",
  contactDescription:
